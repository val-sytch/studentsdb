...
class JournalView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        # get all students from database, or just one if we need to display journal for one student; also check if
        # we need to filter by group
    ...
    def post(self, request, *args, **kwargs):
        ...
        setattr(journal, 'present_day{}'.format(current_date.day), present)
        journal.save()
